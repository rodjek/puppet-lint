...
describe '140chars' do
  ...
  context 'file resource with a template line > 140c' do
    let(:code) { "
      file {
        content => template('mymodule/this/is/a/truely/absurdly/long/path/that/should/make/you/feel/bad/but/now/it/is/even/longer/because/the/style/guide/now/specifies/140/characters'),
      }"
    }
