    ...
    resource_indexes.each do |resource|
      ...
      resource[:param_tokens].select { |param_token|
        ...
        notify(
          ...
          :token       => value_token,
          :description => 'Check the tokens of each File resource instance for a mode parameter and if found, record a warning if the value of that parameter is not a quoted string.',
