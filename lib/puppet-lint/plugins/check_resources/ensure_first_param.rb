  ...
  def check
    resource_indexes.each do |resource|
      ...
      notify(
        ...
        :resource    => resource,
        :description => 'Check the tokens of each resource instance for an ensure parameter and if found, check that it is the first parameter listed.  If it is not the first parameter, record a warning.',
